...
- Name: accesibilidad.spec.ts >> Pantallas internas (con sesión) >> accesibilidad · Planificación
- Location: e2e\accesibilidad.spec.ts:162:5

# Error details

```
Error: Defectos en «Planificación»
        ...
        - generic [ref=f1e19]:
          ...
          - generic [ref=f1e21]:
            - link "Planificación" [ref=f1e22] [cursor=pointer]:
              - /url: "#/planificacion"
            - link "Recepción de leche" [ref=f1e27] [cursor=pointer]:
              - /url: "#/leche"
            - link "Estandarización" [ref=f1e34] [cursor=pointer]:
              - /url: "#/estandarizacion"
            - link "Producción" [ref=f1e38] [cursor=pointer]:
              - /url: "#/produccion"
            - link "Procesos y trazabilidad" [ref=f1e42] [cursor=pointer]:
              - /url: "#/procesos"
            - link "Calidad y liberación" [ref=f1e48] [cursor=pointer]:
              - /url: "#/liberacion"

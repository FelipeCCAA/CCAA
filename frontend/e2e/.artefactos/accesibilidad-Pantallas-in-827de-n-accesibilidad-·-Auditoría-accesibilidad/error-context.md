        ...
        - generic [ref=f1e63]:
          ...
          - generic [ref=f1e65]:
            - link "Abastecimiento" [ref=f1e66] [cursor=pointer]:
              - /url: "#/abastecimiento"
            - link "Inventario y bodegas" [ref=f1e78] [cursor=pointer]:
              - /url: "#/abastecimiento/stock"
        - generic [ref=f1e83]:
          - paragraph [ref=f1e84]: Soporte
          - link "Mantenimiento" [ref=f1e86] [cursor=pointer]:
            - /url: "#/mantenimiento"
        - generic [ref=f1e90]:
          - paragraph [ref=f1e91]: Gestión
          - generic [ref=f1e92]:
            - link "Maestros" [ref=f1e93] [cursor=pointer]:
              - /url: "#/maestros"
            - link "Auditoría" [ref=f1e99] [cursor=pointer]:
              - /url: "#/auditoria"

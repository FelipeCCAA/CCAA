...
- Name: accesibilidad.spec.ts >> Pantallas internas (con sesión) >> accesibilidad · Abastecimiento · Stock
- Location: e2e\accesibilidad.spec.ts:162:5

# Error details

```
Error: Defectos en «Abastecimiento · Stock»
        ...
        - generic [ref=f1e19]:
          ...
          - generic [ref=f1e21]:
            ...
            - link "Calidad y liberación" [ref=f1e47] [cursor=pointer]:
              - /url: "#/liberacion"
            - link "Registros operacionales" [ref=f1e53] [cursor=pointer]:
              - /url: "#/registros"
            - link "Inocuidad · Aseos" [ref=f1e58] [cursor=pointer]:
              - /url: "#/inocuidad/aseos"
        - generic [ref=f1e63]:
          - paragraph [ref=f1e64]: Materiales e inventario
          - generic [ref=f1e65]:
            - link "Abastecimiento" [ref=f1e66] [cursor=pointer]:
              - /url: "#/abastecimiento"
            - link "Inventario y bodegas" [ref=f1e79] [cursor=pointer]:
              - /url: "#/abastecimiento/stock"
        - generic [ref=f1e85]:
          - paragraph [ref=f1e86]: Soporte
          - link "Mantenimiento" [ref=f1e88] [cursor=pointer]:
            - /url: "#/mantenimiento"
        - generic [ref=f1e92]:
          - paragraph [ref=f1e93]: Gestión
          - generic [ref=f1e94]:
            - link "Maestros" [ref=f1e95] [cursor=pointer]:
              - /url: "#/maestros"
            - link "Auditoría" [ref=f1e101] [cursor=pointer]:
              - /url: "#/auditoria"
            - link "Administración" [ref=f1e107] [cursor=pointer]:
              - /url: "#/administracion"
    - generic [ref=f1e114]:
      - generic [ref=f1e115]:
        - generic [ref=f1e116]: Au
        - generic [ref=f1e117]:
          - paragraph [ref=f1e118]: Auditoría Accesibilidad
          - paragraph [ref=f1e119]: Auditoría automática
      - button "Cerrar sesión" [ref=f1e120]
  - main [ref=f1e124]:
    - generic [ref=f1e125]: Cargando módulo…
```

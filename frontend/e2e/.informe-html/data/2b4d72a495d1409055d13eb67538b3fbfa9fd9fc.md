...
- Name: accesibilidad.spec.ts >> Pantallas internas (con sesión) >> accesibilidad · Leche · Descarga a silo
- Location: e2e\accesibilidad.spec.ts:150:5

# Error details

```
Error: Defectos en «Leche · Descarga a silo»
    ...
    - generic [ref=e125]:
      ...
      - generic [ref=e176]:
        - generic [ref=e177]:
          - generic [ref=e178]:
            - generic [ref=e179]:
              - heading "Aprobadas por Calidad" [level=2] [ref=e180]
              - paragraph [ref=e181]: Selecciona Silo 1 o cualquier silo creado, descarga y deja sus litros disponibles inmediatamente en Estandarización.
            - generic [ref=e182]: 0 registros
          - textbox [ref=e184]:
            - /placeholder: Buscar guía, módulo, muestra, camión o silo
        - generic [ref=e185]:
          - paragraph [ref=e192]: Nada aprobado esperando descarga
          - paragraph [ref=e193]: Las cargas aparecen aquí cuando Calidad las libera.
```

...
- Name: accesibilidad.spec.ts >> Pantallas internas (con sesión) >> accesibilidad · Abastecimiento · Calidad
- Location: e2e\accesibilidad.spec.ts:150:5

# Error details

```
Error: Defectos en «Abastecimiento · Calidad»
  ...
  - main [ref=e123]:
    - generic [ref=e125]:
      ...
      - generic [ref=e141]:
        - generic [ref=e142]:
          - generic [ref=e144]:
            - heading "En cuarentena" [level=2] [ref=e145]
            - paragraph [ref=e146]: Material recibido que producción no puede usar hasta que Calidad lo libere.
          - paragraph [ref=e148]: Nada en cuarentena.
        - generic [ref=e149]:
          - generic [ref=e151]:
            - heading "Decididas" [level=2] [ref=e152]
            - paragraph [ref=e153]: "El histórico no se edita: una decisión de Calidad es un registro."
          - paragraph [ref=e155]: Todavía no hay decisiones registradas.
        - generic [ref=e156]:
          - generic [ref=e157]:
            - generic [ref=e159]:
              - heading "No conformidades abiertas" [level=2] [ref=e160]
              - paragraph [ref=e161]: Material que Calidad rechazó u observó, esperando qué se hace con él.
            - paragraph [ref=e163]: Sin no conformidades abiertas.
          - generic [ref=e164]:
            - generic [ref=e166]:
              - heading "Concesiones" [level=2] [ref=e167]
              - paragraph [ref=e168]: "Amparan una cantidad acotada de un lote que Calidad no aprobó, para un uso concreto y con vencimiento. El lote sigue bloqueado para todo lo demás: no entra al stock disponible ni lo toma el FEFO."
            - paragraph [ref=e170]: "Sin concesiones registradas. Se crean en el administrador de Django: autorizar el uso de material no aprobado lo decide Calidad."
          - generic [ref=e171]:
            - heading "Cerradas" [level=2] [ref=e174]
            - paragraph [ref=e176]: Todavía no hay no conformidades cerradas.
```

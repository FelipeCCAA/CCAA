...
- Name: accesibilidad.spec.ts >> Pantallas internas (con sesión) >> accesibilidad · Leche · Rutas
- Location: e2e\accesibilidad.spec.ts:150:5

# Error details

```
Error: Defectos en «Leche · Rutas»
  ...
  - main [ref=e123]:
    - generic [ref=e125]:
      ...
      - generic [ref=e176]:
        - generic [ref=e177]:
          - generic [ref=e178]:
            - heading "Rutas de recolección" [level=2] [ref=e179]
            - paragraph [ref=e180]: Programación, controles en predio y cargas por módulo antes de llegar a planta.
          - button "Nueva ruta" [ref=e181]
        - generic [ref=e183]:
          - heading "Rutas recientes" [level=2] [ref=e185]
          - paragraph [ref=e187]: Crea o selecciona una ruta.
```

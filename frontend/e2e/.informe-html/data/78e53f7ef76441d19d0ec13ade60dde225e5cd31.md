...
- generic [ref=e3]:
  ...
  - main [ref=e123]:
    - generic [ref=e125]:
      - generic [ref=e126]:
        - heading "Registros de planta" [level=1] [ref=e127]
        - paragraph [ref=e131]: Aseos, inspecciones y controles de máquina. Se registran por equipo y fecha; el checklist de los lotes de ese período los toma solo. Un aseo semanal se llena una vez y cubre toda su semana.
      - generic [ref=e132]:
        - combobox [ref=e133]:
          - option "Todos los formularios" [selected]
          - option "Checklist de Cuerpos Extraños Scheffers 2"
          - option "Checklist de Cuerpos Extraños Scheffers 3"
          - option "Checklist de Cuerpos Extraños VEB"
          - option "Inspección Pre-operativa E1-E2"
          - option "Checklist de Cuerpos Extraños Rovema 3 y 4"
        - combobox [ref=e134]:
          - option "Todos los equipos" [selected]
          - option "Carga de precondensado"
          - option "Evaporador Scheffers 2"
          - option "Evaporador Scheffers 3"
          - option "Condensador de flujo"
          - option "Evaporador VEB"
          - option "Torre de secado Egron 1"
          - option "Torre de secado Egron 2"
          - option "Línea de mantequilla"
          - option "Envasadora Rovema 3"
          - option "Envasadora Rovema 4"
        - textbox "Desde" [ref=e135]: 2026-07-18
        - generic [ref=e136]: 0 registro(s)
      - generic [ref=e137]:
        - paragraph [ref=e138]: Registrar un formulario
        - generic [ref=e139]:
          - button "Checklist de Cuerpos Extraños Scheffers 2 · Por ciclo" [ref=e140]:
            - text: Checklist de Cuerpos Extraños Scheffers 2
            - generic [ref=e142]: · Por ciclo
          - button "Checklist de Cuerpos Extraños Scheffers 3 · Por ciclo" [ref=e143]:
            - text: Checklist de Cuerpos Extraños Scheffers 3
            - generic [ref=e145]: · Por ciclo
          - button "Checklist de Cuerpos Extraños VEB · Por ciclo" [ref=e146]:
            - text: Checklist de Cuerpos Extraños VEB
            - generic [ref=e148]: · Por ciclo
          - button "Inspección Pre-operativa E1-E2 · Por ciclo" [ref=e149]:
            - text: Inspección Pre-operativa E1-E2
            - generic [ref=e151]: · Por ciclo
          - button "Checklist de Cuerpos Extraños Rovema 3 y 4 · Por turno" [ref=e152]:
            - text: Checklist de Cuerpos Extraños Rovema 3 y 4
            - generic [ref=e154]: · Por turno
      - paragraph [ref=e156]: Sin registros en el período.
      - paragraph [ref=e157]: "Un registro completado cubre a los lotes de su período sin que nadie lo vuelva a llenar. Un borrador o uno observado no cubre: el primero es trabajo a medias y el segundo es una alerta abierta."
```

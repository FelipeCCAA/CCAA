...
- generic [ref=e3]:
  ...
  - main [ref=e123]:
    - generic [ref=e124]:
      - generic [ref=e125]:
        - generic [ref=e126]:
          - heading "Planificación semanal" [level=1] [ref=e127]
          - paragraph [ref=e128]: El programa horario genera el consumo del balance de leche.
        - generic [ref=e129]:
          - combobox [ref=e130]:
            - option "Sin semanas" [selected]
          - button "Nueva semana" [ref=e131]
      - paragraph [ref=e133]: Todavía no hay ninguna semana planificada.
```

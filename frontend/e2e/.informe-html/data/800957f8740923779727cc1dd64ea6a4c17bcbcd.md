...
- Name: accesibilidad.spec.ts >> Pantallas internas (con sesión) >> accesibilidad · Abastecimiento · Recepción
- Location: e2e\accesibilidad.spec.ts:150:5

# Error details

```
Error: Defectos en «Abastecimiento · Recepción»
...
- generic [ref=e3]:
  ...
  - main [ref=e123]:
    - generic [ref=e125]:
      ...
      - generic [ref=e142]:
        - generic [ref=e144]:
          - heading "Pendiente de recibir" [level=2] [ref=e145]
          - paragraph [ref=e146]: Lo comprometido con proveedores que todavía no llega. Cada línea se recibe contra su renglón de la orden.
        - paragraph [ref=e148]: No hay órdenes enviadas esperando material. Se emiten desde Compras, al convertir una solicitud aprobada.
```

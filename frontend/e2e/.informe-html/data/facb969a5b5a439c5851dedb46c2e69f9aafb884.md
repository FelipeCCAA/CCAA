...
- Name: accesibilidad.spec.ts >> Pantallas internas (con sesión) >> accesibilidad · Mantenimiento
- Location: e2e\accesibilidad.spec.ts:150:5

# Error details

```
Error: Defectos en «Mantenimiento»
...
- generic [ref=e3]:
  ...
  - main [ref=e123]:
    - main [ref=e124]:
      - generic [ref=e125]:
        - generic [ref=e126]:
          - paragraph [ref=e127]: Activos
          - heading "Mantenimiento" [level=1] [ref=e128]
          - paragraph [ref=e129]: Planes preventivos, fallas, órdenes de trabajo y disponibilidad de equipos.
        - generic [ref=e130]:
          - article [ref=e131]:
            - generic [ref=e133]:
              - paragraph [ref=e134]: Órdenes abiertas
              - paragraph [ref=e135]: "0"
          - article [ref=e139]:
            - generic [ref=e141]:
              - paragraph [ref=e142]: Planes vencidos
              - paragraph [ref=e143]: "0"
          - article [ref=e148]:
            - generic [ref=e150]:
              - paragraph [ref=e151]: Fallas críticas
              - paragraph [ref=e152]: "0"
        - generic [ref=e156]:
          - paragraph [ref=e157]: Sin órdenes de trabajo
          - paragraph [ref=e158]: Crea el primer plan preventivo u orden correctiva desde el módulo.
```

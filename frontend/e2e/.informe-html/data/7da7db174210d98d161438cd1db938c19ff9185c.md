...
- Name: accesibilidad.spec.ts >> Pantallas internas (con sesión) >> accesibilidad · Abastecimiento · Panel
- Location: e2e\accesibilidad.spec.ts:150:5

# Error details

```
Error: Defectos en «Abastecimiento · Panel»
  ...
  - main [ref=e123]:
    - generic [ref=e125]:
      ...
      - generic [ref=e141]:
        - generic [ref=e142]:
          - generic [ref=e143]:
            - paragraph [ref=e154]: Stock disponible
            - paragraph [ref=e155]: "0"
          - generic [ref=e156]:
            - paragraph [ref=e159]: En cuarentena
            - paragraph [ref=e160]: "0"
          - generic [ref=e161]:
            - paragraph [ref=e166]: Inspecciones pendientes
            - paragraph [ref=e167]: "0"
          - generic [ref=e168]:
            - paragraph [ref=e174]: Pedidos abiertos
            - paragraph [ref=e175]: "0"
        - generic [ref=e176]:
          - generic [ref=e177]:
            - generic [ref=e179]:
              - heading "Alertas vigentes" [level=2] [ref=e180]
              - paragraph [ref=e181]: "Las calcula el sistema en cada movimiento. No se cierran a mano: se apagan arreglando lo que las causó."
            - paragraph [ref=e183]: Sin alertas. Todo dentro de sus límites.
          - generic [ref=e184]:
            - generic [ref=e185]:
              - generic [ref=e187]:
                - heading "Lo que está esperando" [level=2] [ref=e188]
                - paragraph [ref=e189]: Documentos detenidos hasta que alguien decida.
              - paragraph [ref=e191]: Nada pendiente de decisión.
            - generic [ref=e192]:
              - heading "Notificaciones" [level=2] [ref=e195]
              - paragraph [ref=e197]: Sin notificaciones.
```

...
- Name: accesibilidad.spec.ts >> Pantallas internas (con sesión) >> accesibilidad · Leche · Muestreo
- Location: e2e\accesibilidad.spec.ts:150:5

# Error details

```
Error: Defectos en «Leche · Muestreo»
    ...
    - generic [ref=e125]:
      ...
      - generic [ref=e176]:
        - generic [ref=e177]:
          - generic [ref=e178]:
            - generic [ref=e179]:
              - heading "Por muestrear" [level=2] [ref=e180]
              - paragraph [ref=e181]: Elige quién realiza la prueba. La crioscopía será por módulo; el resto de los controles se comparte para todo el camión.
            - generic [ref=e182]: 0 registros
          - textbox [ref=e184]:
            - /placeholder: Buscar guía, módulo, muestra, camión o silo
        - generic [ref=e185]:
          - paragraph [ref=e192]: No hay módulos esperando muestra
          - paragraph [ref=e193]: Cuando se registre una llegada aparecerá aquí.
```

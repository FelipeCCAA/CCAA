...
- Name: accesibilidad.spec.ts >> Pantallas internas (con sesión) >> accesibilidad · Abastecimiento · Pedidos
- Location: e2e\accesibilidad.spec.ts:150:5

# Error details

```
Error: Defectos en «Abastecimiento · Pedidos»
  ...
  - main [ref=e123]:
    - generic [ref=e125]:
      ...
      - generic [ref=e141]:
        - generic [ref=e142]:
          - generic [ref=e144]:
            - heading "Pedidos abiertos" [level=2] [ref=e145]
            - paragraph [ref=e146]: Reservar aparta el material sin sacarlo; entregar es lo que lo mueve.
          - paragraph [ref=e148]: Sin pedidos abiertos.
        - generic [ref=e149]:
          - heading "Pedidos cerrados" [level=2] [ref=e152]
          - paragraph [ref=e154]: Todavía no hay pedidos cerrados.
```

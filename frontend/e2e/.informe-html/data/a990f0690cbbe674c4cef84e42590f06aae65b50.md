...
- Name: accesibilidad.spec.ts >> Pantallas internas (con sesión) >> accesibilidad · Leche · Calidad
- Location: e2e\accesibilidad.spec.ts:150:5

# Error details

```
Error: Defectos en «Leche · Calidad»
    ...
    - generic [ref=e125]:
      ...
      - generic [ref=e176]:
        - generic [ref=e177]:
          - generic [ref=e178]:
            - generic [ref=e179]:
              - heading "Muestras por decidir" [level=2] [ref=e180]
              - paragraph [ref=e181]: Completa una vez los controles del camión y registra únicamente la crioscopía propia de cada módulo.
            - generic [ref=e182]: 0 registros
          - textbox [ref=e184]:
            - /placeholder: Buscar guía, módulo, muestra, camión o silo
        - generic [ref=e185]:
          - paragraph [ref=e192]: No hay muestras pendientes
          - paragraph [ref=e193]: Nada esperando decisión de Calidad.
```

...
- Name: accesibilidad.spec.ts >> Pantallas de acceso (sin sesión) >> accesibilidad · Recuperar contraseña
- Location: e2e\accesibilidad.spec.ts:137:5

# Error details

```
Error: Defectos en «Recuperar contraseña»
  ...
  - generic [ref=e5]:
    ...
    - generic [ref=e37]:
      - link "Volver" [ref=e39] [cursor=pointer]:
        - /url: "#/login"
      - generic [ref=e42]:
        - generic [ref=e43]: Paso 1 de 2
        - heading "Recupera tu contraseña" [level=1] [ref=e49]
        - paragraph [ref=e50]: Ingresa el correo asociado a tu cuenta. Te enviaremos las instrucciones para crear una contraseña nueva.
        - generic [ref=e52]:
          - generic [ref=e53]:
            - generic [ref=e54]: Correo electrónico
            - textbox "Correo electrónico" [active] [ref=e59]:
              - /placeholder: nombre@camposaustrales.cl
            - paragraph [ref=e60]: Usa el mismo correo registrado por el administrador.
          - button "Enviar enlace seguro" [ref=e61]
      - paragraph [ref=e64]: ¿Necesitas ayuda? Contacta al administrador del sistema.
```

...
- Name: accesibilidad.spec.ts >> Pantallas internas (con sesión) >> accesibilidad · Abastecimiento · Compras
- Location: e2e\accesibilidad.spec.ts:150:5

# Error details

```
Error: Defectos en «Abastecimiento · Compras»
    ...
    - generic [ref=e125]:
      ...
      - generic [ref=e141]:
        - generic [ref=e142]:
          - generic [ref=e143]:
            - generic [ref=e144]:
              - heading "Solicitudes de compra" [level=2] [ref=e145]
              - paragraph [ref=e146]: Lo que se pidió y en qué punto está. Las que vienen del MRP traen sus líneas marcadas.
            - combobox "Bodega donde se recibe el material al convertir" [ref=e147]:
              - option "Bodega de entrega…" [selected]
          - paragraph [ref=e149]: No hay solicitudes abiertas. Se generan desde el MRP o se crean a mano en el administrador.
        - generic [ref=e150]:
          - generic [ref=e152]:
            - heading "Órdenes de compra" [level=2] [ref=e153]
            - paragraph [ref=e154]: Lo comprometido con proveedores. «Recibida» la marca la recepción contra la orden, no un botón.
          - paragraph [ref=e156]: Sin órdenes de compra.
        - generic [ref=e157]:
          - heading "Lo que falta en esta pestaña" [level=2] [ref=e160]
          - list [ref=e162]:
            - listitem [ref=e163]: · Recepción contra orden, que es lo que crea el lote y lo manda a cuarentena. El servicio existe; falta la pantalla.
            - listitem [ref=e164]: "· Proveedores y sus condiciones por material: precio, compra mínima, múltiplo y plazo. Hoy se cargan en el administrador, y sin un proveedor principal la solicitud no se puede convertir."
```

  ...
  const cargar = useCallback(async () => {
    ...
    try {
      const [producidos, cerrados, paginaRegistros, paginaPallets] = await Promise.all([
        buscarLotes({ estado: "producido", naturaleza: "terminado" }),
        buscarLotes({ estado: "cerrado", naturaleza: "terminado" }),
